...
Who would've thought that PHP would have to wait for a truly native and understandable function to check if the a string is contained in another string until its version 8 or rather 25 years after its inception?!
