---
layout: post
title: JavaScript functions' implementation inspired by PHP and Laravel
categories: [JavaScript, PHP, Laravel]
---

A sometime ago I tried my hands on [implementing](https://github.com/amitmerchant1990/essential-vanilla-javascript-functions) some of the PHP's native functions in native JavaScript. The result is quite interesting list of JavaScript functions you've never asked about. 

Here some of the function implementation are also inspired from [Laravel Collections](https://laravel.com/docs/5.8/collections) functions. Let's go.
